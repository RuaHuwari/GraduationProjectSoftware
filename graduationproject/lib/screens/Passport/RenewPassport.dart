...
class ReNewPassport extends StatefulWidget {
  ReNewPassport({ required this.userId, required this.firstname, required this.lastname});
  final String userId;
  ...
  Future<void> _saveData(
    ...
    if (name == "") {
      ...
      try {
        ...
        String uri="http://192.168.1.103/palease_api/insert_application.php";
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'In order to Renew your Passport, you need to have these files ready:',
                  style: TextStyle(
                    fontSize: 15,
                    color: primary,
                  ),),
                ...
                Text('3. An Agreement of your father or the one in charge of you, if you are younger than 18',
                  style: TextStyle(
                    fontSize: 12,
                    color: primary,
                  ),),
                ...
                Text('5. Manager Agreement if you want to renew your passport when it still have more than 6 months till it expires',
                  style: TextStyle(
                    fontSize: 12,
                    color: primary,
                  ),),
                Text('6. When you come to get your passport, bring in the old one',
                  style: TextStyle(
                    fontSize: 12,
                    color: primary,
                  ),),
                Text('7. You will need to pay 35 JOD to get the passport',
                  style: TextStyle(
                    fontSize: 12,
                    color: primary,
                  ),),
    ...
    return Container(
      ...
      child:ListView(
        ...
        children: [
          ...
          CheckboxListTile(
            title: Text("Will your passport stay valid for the next 6 months?"),
          ...
          if (_passportValidFor6Months)
            TextFormField(
              ...
              decoration: InputDecoration(labelText: "Reason for renewing"),
              style: TextStyle(color: primary),
              validator: (value) {
                if (value == null || value.isEmpty) {
          ...
          if(_passportValidFor6Months)
            ...
            ElevatedButton.icon(
              ...
              icon: Icon(Icons.image),
              label: Text('Select Picture of Manager Agreement'),
            ):Column(
              children: [
                Text(
                  'Selected File:',
