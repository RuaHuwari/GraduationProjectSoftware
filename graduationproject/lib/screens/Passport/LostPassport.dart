...
class LostPassport extends StatefulWidget {
  LostPassport({ required this.userId, required this.firstname, required this.lastname});
  final String userId;
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'In order to get a new Passport, you need to have these files ready:',
                  style: TextStyle(
                    fontSize: 15,
                    color: primary,
                  ),),
                ...
                Text('5. if the lost passport still not expired you will need to attach: police report, newpaper announcement',
                  style: TextStyle(
                    fontSize: 12,
                    color: primary,
                  ),),
                Text('6. You will need to pay 35 JOD to get the passport',
                  style: TextStyle(
                    fontSize: 12,
                    color: primary,
                  ),),
    ...
    return Container(
      ...
      child:ListView(
        ...
        children: [
          ...
          CheckboxListTile(
            title: Text("Is the lost passport still Valid?"),
          ...
          if (_passportValidFor6Months)
            ...
            ElevatedButton.icon(
              ...
              icon: Icon(Icons.image),
              label: Text('Select Picture of Police Report'),
            ):Column(
              children: [
                Text(
                  'Selected File:',
          ...
          if(_passportValidFor6Months)
            ...
            ElevatedButton.icon(
              ...
              icon: Icon(Icons.image),
              label: Text('Select Picture of NewPaper Announcement'),
            ):Column(
              children: [
                Text(
                  'Selected File:',
