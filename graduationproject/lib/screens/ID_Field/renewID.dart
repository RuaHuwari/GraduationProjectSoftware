...
class renewId extends StatefulWidget {
  renewId({ required this.userId, required this.firstname, required this.lastname});
  final String userId;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Renew ID ', style: TextStyle(
            color: Colors.white,
            fontSize: 35,
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('2. A picture of the Old ID.', style: TextStyle(
                  fontSize: 15,
                  color: primary,
                ), textAlign: TextAlign.left),
                Text('3. You will need to pay a fee of 7.00 JOD.',
                  style: TextStyle(
                    fontSize: 15,
                    color: primary,
                  ),),
      ...
      child:ListView(
        ...
        children: [
          ...
          _OldID== null
            ...
            label: Text('Select Picture of Old ID'),
          )
              :   Column(
            children: [
              Text(
