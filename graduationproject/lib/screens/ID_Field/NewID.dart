...
class NewID extends StatefulWidget {
  NewID({ required this.userId, required this.firstname, required this.lastname});
  final String userId;
...
class _NewIDState extends State<NewID> {
    ...
    if (name == "" ||
      ...
      try {
        ...
        var response=await http.post(Uri.parse(uri),body: {
          ...
          "dob": formattedDOB,
          "name": name,
          "numberofsons":numberofsonsStr,
          "numberofdaughters": numberofdaughtersStr,
          "status": "Not Done",
        ...
        if (response.statusCode == 200) {
          ...
          String id=responseBody['inserted_id'].toString();
          _saveApplicationIdToFirestore(id);
         Navigator.push(
           context,
           MaterialPageRoute(builder: (context)=>pay(userId: widget.userId, firstname: widget.firstname, lastname: widget.lastname, price: 2, applicationID: id))
         );
        } else {
  ...
  Future<String> _saveApplicationIdToFirestore(String applicationId) async {
    ...
    try {
      ...
      print('1');
     // String _imageurl=await storeData.UploadImageToStorage(applicationId+'personalimage',_image!) ;
      ...
      referenceDirImages.child(applicationId+'personalimage.jpg');
      ...
      referenceImageToUpload =
          referenceDirImages.child(applicationId+'BirthCertificate.jpg');
      try {
        //Store the file
        await referenceImageToUpload.putFile(_birthCertificate!);
        //Success: get the download URL
        birthurl = await referenceImageToUpload.getDownloadURL();
      } catch (error) {
        //Some error occurred
      }
     // String _birthurl=await storeData.UploadImageToStorage(applicationId+'BirthCertificate',_birthCertificate!) ;
      print('3');
      ...
      await _firestore.collection("IDApplications").add({
        ...
        'applicationID': 1,
        'departmentID':1,
        'user_id':_idNumberController.text,
  ...
  Future<void> _getBirthCertificate() async {
    ...
    if (pickedFile != null) {
      setState(() {
        _birthCertificate = File(pickedFile.path);
      });
    }
    // Uint8List img = await pickImage(ImageSource.gallery);
    // setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Get New ID', style: TextStyle(
            color: Colors.white,
            fontSize: 35,
              ...
              children: [
                Container(
                  ...
                  width: MediaQuery
                      ...
                      .width,
                  child: Padding(
                    padding: const EdgeInsets.fromLTRB(10.0, 40.0, 18.0, 80.0),
                    child:
                    PageView(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('4. You will need to pay a fee of 2.00 JOD.',
                  style: TextStyle(
                    fontSize: 15,
                    color: primary,
                  ),),
        ...
        children: [
          ...
          _birthCertificate == null
            ...
            children: [
              ...
              Image.file(File(_birthCertificate!.path)),
            ],
          ),
          SizedBox(height: 20),
          ElevatedButton(
...
//
//                 // Once operations are done, stop loading
//                 _stopLoading();
//                 showMessageDialog(context,'Success','Your Application has been submitted successfully!');
//               });
