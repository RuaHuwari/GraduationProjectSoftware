...
import 'package:graduationprojectweb/screens/api_connection/api_connection.dart';
import 'package:graduationprojectweb/screens/user/chat/chatdetail.dart';
import 'package:graduationprojectweb/screens/user/chat/workermodel.dart';
...
class _NewChatScreenState extends State<NewChatScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: buildabbbar.buildAbbbar(context, 'Start New Chat', widget.userId, widget.firstname, widget.lastname,isEnglish,_toggleLanguage),
