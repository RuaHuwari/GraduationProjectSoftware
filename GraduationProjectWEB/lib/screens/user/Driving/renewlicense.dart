...
class RenewLicense extends StatefulWidget {
  RenewLicense({required this.userId, required this.firstname, required this.lastname, required this.isEnglish});
  final String userId;
  ...
  Future<String> _saveApplicationIdToFirestore(String applicationId) async {
    ...
    try {
      ...
      final QuerySnapshot querySnapshot = await _firestore
          ...
          .where('applicationID', isEqualTo: '10')
          .get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: buildabbbar.buildAbbbar(
        context,
        isEnglish ? 'Form for License Renewal' : 'نموذج لتجديد الرخصة',
        widget.userId,
        widget.firstname,
        widget.lastname,
        isEnglish,
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      child: Text(isEnglish ? 'Select Image of the Old License' : ' ارفق صورة الرخصة القديمة'),
                    ),
                    SizedBox(height: 20),
                    ElevatedButton(
                      onPressed: () async {
                        ...
                        _saveData(applicationID.toString(), _selectedDate.toString(),
                            firstNameController.text, 'Not Done');
